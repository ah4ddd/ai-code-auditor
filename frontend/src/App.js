                            ...
                            {scanMode === 'files' ? (
                                ...
                                <div className="repo-scan-modern">
                                    <div className="upload-zone-modern">
                                        ...
                                        {/* Platform Logos - Clean, no container */}
                                        <div className="platform-logos-clean">
                                            <svg viewBox="0 0 24 24" width="36" height="36" className="platform-icon" title="GitHub">
                                            ...
                                            <svg viewBox="0 0 24 24" width="36" height="36" className="platform-icon" title="GitLab">
                                                <path d="M23.546 10.93L13.067.452c-.604-.603-1.582-.603-2.188 0L8.708 2.627l2.76 2.76c.645-.215 1.379-.07 1.889.441.516.515.658 1.258.438 1.9l2.658 2.66c.645-.223 1.387-.078 1.9.435.721.72.721 1.884 0 2.604-.719.719-1.881.719-2.6 0-.539-.541-.674-1.337-.404-1.996L12.86 8.955v6.525c.176.086.342.203.488.348.713.721.713 1.883 0 2.6-.719.721-1.889.721-2.609 0-.719-.719-.719-1.879 0-2.598.182-.18.387-.316.605-.406V8.835c-.217-.091-.424-.222-.6-.401-.545-.545-.676-1.342-.396-2.009L7.636 3.7.45 10.881c-.6.605-.6 1.584 0 2.189l10.48 10.477c.604.604 1.582.604 2.186 0l10.43-10.43c.605-.603.605-1.582 0-2.187" />
                                            </svg>
                                            <svg viewBox="0 0 24 24" width="36" height="36" className="platform-icon" title="Bitbucket">
                                                <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 2.4c5.302 0 9.6 4.298 9.6 9.6s-4.298 9.6-9.6 9.6S2.4 17.302 2.4 12 6.698 2.4 12 2.4zm1.44 3.84c-.72 0-1.302.582-1.302 1.302v2.4H9.658c-.72 0-1.302.582-1.302 1.302s.582 1.302 1.302 1.302h2.48v6c0 .72.582 1.302 1.302 1.302s1.302-.582 1.302-1.302v-6h2.48c.72 0 1.302-.582 1.302-1.302s-.582-1.302-1.302-1.302h-2.48v-2.4c0-.72-.582-1.302-1.302-1.302z" />
                                            </svg>
                                        </div>
