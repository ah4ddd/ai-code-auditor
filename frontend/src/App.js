                                    ...
                                    <div className="upload-zone-modern">
                                        ...
                                        <div className="platform-logos-clean">
                                            ...
                                            <svg viewBox="0 0 24 24" width="36" height="36" className="platform-icon" title="Bitbucket">
                                                <path d="M.778 1.211c-.424 0-.772.347-.772.772 0 .055.011.11.022.165L3.45 22.126c.055.424.424.748.848.748h15.016c.313 0 .591-.22.658-.523l3.422-19.978c.055-.424-.22-.848-.644-.903a.766.766 0 00-.165 0H.778zm14.52 15.528H8.7l-1.313-6.994h8.144l-1.233 6.994z" />
                                            </svg>
                                        </div>
